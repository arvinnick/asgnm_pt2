...
#
# TODO: Modify `process_payments()` to print a checksum of bytes written by `stream_payments_to_storage()`.
...
class SummedStream(BufferedWriter):
...
def process_payments():
    ...
    buffer = SummedStream(get_payments_storage())
